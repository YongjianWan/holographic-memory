...
当前稳定快照以 [SESSION.md](SESSION.md) 为准：`4347 total / 2200 active / 2147 soft-deleted / schema v10`，active category 为 `project 2083 / personal 111 / user_pref 5 / general 1`。旧的 `2078/2071/333/1051/1034` 等数字只作为历史口径，不能再驱动 schema 决策。
